...
function combineColumn() {
  for (let i = 0; i < 4; i++) {
    ...
    for (let j = 0; j < 12; j += 4) {
      // Iterate through tiles in a column
      if (
        squares[j + i].innerHTML === squares[j + i + 4].innerHTML &&
        squares[j + i].innerHTML !== "0"
      ) {
